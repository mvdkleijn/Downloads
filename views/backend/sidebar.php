...
<p class="button"><a href="<?php echo get_url('plugin/downloads/files/add'); ?>"><img src="../wolf/plugins/downloads/images/download-add.png" align="middle" alt="Add a Download" /> Add Download</a></p>
